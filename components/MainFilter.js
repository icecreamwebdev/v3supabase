...
const MainFilter = () => {
    return (
        <div className='flex w-full bg-gray-100 h-10 z-1 flex-row px-5 items-center text-xs font-semibold text-gray-500 uppercase'>
            ...
            <div className='basis-72  flex-grow px1 flex  justify-center border-r border-gray-400 '>Event</div>
            <div className='basis-72  px-1 flex  justify-center border-r border-gray-400 '>comp</div>
